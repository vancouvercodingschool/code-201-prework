...
If you are completely new to coding, consider completing <a href="https://vancouvercodingschool.com/code-101-explore-software-development/">Code 101</a> to build your first website using HTML and CSS and to find out if a career in software development is right for you.

##### 2. Ensure your laptop is up to the task of coding specified in the [Material Requirements](https://vancouvercodingschool.com/code-201-foundations-software-development/) *(time for this can vary widely depending upon the age and condition of your laptop)*
